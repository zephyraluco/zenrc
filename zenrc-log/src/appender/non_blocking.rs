...
///
/// This struct implements [`tracing_subscriber::fmt::MakeWriter`] from the `tracing-subscriber`
/// crate. Therefore, it can be used with the [`mod@tracing_subscriber::fmt`] module
